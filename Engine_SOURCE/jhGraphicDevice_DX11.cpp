...
namespace jh::graphics
{
    ...
    bool GraphicDevice_DX11::CreateInputLayout(D3D11_INPUT_ELEMENT_DESC* desc, UINT NumElements,
        const void* byteCode, SIZE_T bytecodeLength, ID3D11InputLayout** ppInputLayout)
    {
    ...
    bool GraphicDevice_DX11::CreateUnorderedAccessView(ID3D11Resource* pResource,
    ...
    bool GraphicDevice_DX11::CreateGeometryShader(const void* pShaderBytecode,
        SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage,
        ID3D11GeometryShader** ppVertexShader)
    {
        if (FAILED(mDevice->CreateGeometryShader(pShaderBytecode, BytecodeLength, pClassLinkage, ppVertexShader)))
            return false;
    ...
    bool GraphicDevice_DX11::CreateComputeShader(const void* pShaderBytecode,
        SIZE_T BytecodeLength, ID3D11ClassLinkage* pClassLinkage,
    ...
    void GraphicDevice_DX11::BindIndexBuffer(ID3D11Buffer* pIndexBuffer, DXGI_FORMAT Format,
        UINT Offset)
    {
    ...
    void GraphicDevice_DX11::CopyResource(ID3D11Resource* pDstResource,
    ...
    void GraphicDevice_DX11::Clear()
    {
        ...
        mContext->ClearDepthStencilView(mDepthStencilBufferTexture->GetDSV().Get(),
    ...
    void GraphicDevice_DX11::DrawIndexed(UINT indexCount, UINT StartIndexLocation,
